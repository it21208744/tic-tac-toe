...
const patterns = [
  {
    ...
    sequence: ["circle.png", "heart.png", "circle.png", "heart.png","circle.png", "heart.png", null],
  ...
  },
  {
    id: 2,
    question: "What comes next in this pattern?",
    sequence: ["star.png", "triangle.png", "star.png", "triangle.png",, "star.png","triangle.png", null],
  ...
  },
  {
    id: 6,
    question: "What comes next in this pattern?",
    sequence: ["circle.png", "heart.png", "circle.png", null, "circle.png", "heart.png","circle.png", "heart.png"],
    options: ["circle.png", "heart.png"],
    answer: "heart.png",
    missingIndex: 3,
    points: 5,
  },
  {
    id: 7,
    question: "What comes next in this pattern?",
    sequence: ["star.png", "triangle.png", "star.png", "triangle.png", null,"triangle.png", "star.png"],
    options: ["triangle.png", "star.png"],
    answer: "star.png",
    missingIndex: 4,
    points: 7,
  },
  {
    id: 8,
    question: "What comes next in this pattern?",
    sequence: [null, "hextogen.png", "star.png", "triangle.png", "hextogen.png", "star.png", "triangle.png"],
    options: ["triangle.png", "star.png", "hextogen.png"],
    answer: "triangle.png",
    missingIndex: 0,
    points: 10,
  },
  {
    id: 9,
    question: "What comes next in this pattern?",
    sequence: ["right.png", "left.png", null,  "left.png","right.png", "left.png","right.png", "left.png"],
    options: ["right.png", "left.png"],
    answer: "right.png",
    missingIndex: 2,
    points: 15,
  ...
  },
  {
    id: 11,
    question: "What comes next in this pattern?",
    sequence: ["tennis.png", "football.png", "ruggerball.png", null, "football.png", "ruggerball.png","tennis.png", "football.png"],
...
const Lo = () => {
  ...
  const exportToExcel = () => {
    const data = [
      {Logical_Score: score, Logical_Task_Errors: errors, "Logical_Task_Completion_Time (s)": totalTime },
    ];
        ...
        <div key={pattern.id} className="pattern-container">
          ...
          <div className="sequence">
            {pattern.sequence.map((img, index) =>
              img ? (
                <img key={index} src={`/images/${img}`} alt="" className="pattern-img" />
              ) : (
                <div key={index} className="missing-part">---------------------?</div>
              )
            )}
          </div>
